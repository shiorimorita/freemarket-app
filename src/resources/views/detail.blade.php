    ...
    <div class="item-detail__right">
            ...
            <div class="like">
                <form action="/item/{{ $item->id }}/like" method="post" class="like__form">
                    ...
                    <button type="submit" class="like__button" aria-label="いいね">
                        <svg class="like__icon {{ $liked ? 'is-liked' : '' }}" viewBox="0 0 24 24" width="32" height="32" aria-hidden="true">
                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" class="like__icon-path" />
                        </svg>
                    </button>
        ...
        <div class="item-comment">
            ...
            <form action="/item/{{ $item->id }}/comment" method="post" class="comment-form">
                ...
                <p class="comment__error input-error">
                    @error('content')
                    {{ $message }}
                    @enderror
                </p>
